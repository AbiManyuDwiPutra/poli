    ...
    <div class="card card-outline card-primary">
      ...
      <div class="card-body">
        ...
        <form action="" method="post">
          ...
          <div class="input-group mb-3">
            <input type="password" class="form-control" placeholder="Password | Case Sensitive" name="alamat">
            <div class="input-group-append">
              <div class="input-group-text">
        ...
        <!-- /.social-auth-links -->
        <p class="mb-0">
          <a href="registerUser.php" class="text-center">I already have an acoount</a>
        </p>
      </div>
      <!-- /.card-body -->
    </div>
...
if (isset($_POST['submit'])) {
  ...
  if ($username == 'admin') {
    if ($password == 'admin') {
      ...
      echo '<meta http-equif="refresh" content="0; url=../admin">';
      die();
    }
  } else {
    ...
    try {
      ...
      if ($cek_username->rowCount() == 1) {
        ...
        if ($password == $row['alamat']) {
          ...
          echo '<meta http-equif="refresh" content="0; url=../pasien">';
          die();
        }
      }
